...
export function RepeatControl({ doneToday, target, remaining, onUndo, readOnly }: Props) {
  const c = useColors();
  ...
  return (
    <View style={s.row}>
      ...
      {!readOnly && doneToday > 0 && (
        <TouchableOpacity onPress={onUndo} hitSlop={8} accessibilityLabel="Undo the last check-in">
