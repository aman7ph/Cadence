...
export function ComposerSpreadPanel({
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col gap-2.5 md:border-l md:border-[var(--border-subtle)] md:pl-5">
      <div className="flex items-center justify-between gap-2">
        <span className="flex items-center gap-1.5">
          <Repeat className="size-3 text-[var(--text-accent)]" strokeWidth={2.5} />
