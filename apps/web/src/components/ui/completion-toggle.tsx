...
interface CompletionToggleProps extends Omit<
...
const CompletionToggle = React.forwardRef<
  HTMLButtonElement,
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isComplete
          ? "border-[var(--status-complete)] bg-[var(--status-complete)] text-[var(--text-on-accent)] shadow-[var(--shadow-success)]"
          : isSkipped
